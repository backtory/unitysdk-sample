...
using Assets.BacktorySDK.core.Reflection;
using RestSharp;
 ...
 class JsonArray : List<object>
    {
        ...
        {
            return MySimpleJson.SerializeObject(this) ?? string.Empty;
        }
    }
 ...
 IDictionary<string, object>
    {
        ...
        public override string ToString()
        {
            return MySimpleJson.SerializeObject(this);
        }
 ...
 static class MySimpleJson
    {
        ...
        static MySimpleJson()
        {
            ...
            // changed by Alireza Farahani.
            //CurrentJsonSerializerStrategy = new SnakeJsonSerializerStrategy();
        }
